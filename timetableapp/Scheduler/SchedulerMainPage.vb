...
Public Class SchedulerMainPage
    ...
    Private Sub ActivateButton(senderBtn As Object, customColor As Color)
        If senderBtn IsNot Nothing Then
            ...
            currentBtn.BackColor = Color.FromArgb(12, 20, 21)
    ...
    Private Sub IconButton1_Click(sender As Object, e As EventArgs) Handles btnUserProfile.Click
        ...
        OpenChildForm(New SchedulerProfile)
    End Sub

    Private Sub btnDashboard_Click(sender As Object, e As EventArgs) Handles btnManageUser.Click
