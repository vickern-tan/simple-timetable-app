...
Public Class ForgetPassword
    ...
    Private Sub btnReset_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        SavedPassword = studentlogin.txtUserPassword.Text
        Try
            ...
            Dim da1 As New OleDb.OleDbDataAdapter("SELECT * FROM StudentAccount WHERE StudentEmail ='" & Trim(txtUserMail.Text) & "' AND StudentID ='" & Trim(txtStudentID.Text) & "'", con)
            ' CHECK IF PASSWORD LENGTH IS MORE THAN 5 CHARACTER AND StudentPassword = & Trim(txtNewPass.Text) & 
            ...
            Else
                ...
                If txtUserMail.Text.Trim.Length > 0 AndAlso txtStudentID.Text.Trim.Length > 0 AndAlso txtNewPass.Text.Trim.Length > 0 AndAlso txtConPass.Text.Trim.Length > 0 Then
                    If (txtNewPass.Text = txtConPass.Text) Then
                        If da1.Fill(ds1) Then
                            ...
                            con.Open()
                            cb = New OleDb.OleDbCommand("UPDATE StudentAccount SET StudentPassword ='" & txtNewPass.Text & "' WHERE StudentEmail ='" & txtUserMail.Text &
                                "' AND StudentID = '" & txtStudentID.Text & "'", con)
    ...
    Private Sub btnBack_Click(sender As Object, e As EventArgs) Handles btnBack.Click
        If MsgBox("Quit Resetting Password?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Back|Student Login") = MsgBoxResult.Yes Then
            Me.Hide()
            studentlogin.Show()
        End If
    End Sub
